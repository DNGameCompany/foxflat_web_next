            ...
            >
                ...
                <section className="space-y-8 text-neutral-200">
                    ...
                    <div>
                        ...
                        <ul className="list-none space-y-1">
                            <li>
                                9.1. Видалення акаунта через налаштування бота видаляє профіль та дані Користувача,
                                проте не є скасуванням оплаченої передплати. Якщо строк дії передплати ще не закінчився,
                                при повторній реєстрації в боті доступ до платного функціоналу відновлюється автоматично
                                до завершення оплаченого періоду.
                            </li>
                            <li>
                                9.2. Передплата діє протягом строку, визначеного обраним Тарифом, незалежно від видалення
                                чи повторного створення акаунта Користувачем у межах цього строку.
                            </li>
                            <li>
                                9.3. Оскільки повний доступ до платних функцій бота надається негайно в момент оплати, відповідно до Закону України &quot;Про цифровий контент та цифрові послуги&quot; така послуга вважається наданою в повному обсязі, і повернення коштів за підписку належної якості не передбачено.
                            </li>
                            <li>
                                9.4. Спірні питання щодо якості послуг розглядаються за зверненням через Telegram:{' '}
                                <a href={pageData.supportTelegram} className="text-orange-400 hover:text-orange-300">
                                    @FoxFlatSupport
                                </a>.
                            </li>
                            <li>
                                9.5. Виконавець не відшкодовує кошти за невикористання послуг через причини, що не
                                залежать від нього, включно з випадками, коли Замовник самостійно видалив акаунт протягом
                                оплаченого періоду.
                            </li>
                        </ul>
                    </div>
