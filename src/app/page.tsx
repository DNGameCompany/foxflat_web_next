...
export const metadata = {
    ...
    description:
        'FoxFlat — Telegram-бот для пошуку квартир у Києві, Львові, Одесі, Харкові, Дніпрі, Запоріжжі та ще 22 містах України. Актуальні оголошення оренди без посередників щодня прямо в Telegram!',
    keywords: [
        'оренда квартир Київ',
        'оренда квартир Львів',
        'оренда квартир Одеса',
        'оренда квартир Харків',
        'оренда квартир Дніпро',
        'оренда квартир Запоріжжя',
    ...
    openGraph: {
        ...
        description:
            'Знаходь квартири миттєво через зручного Telegram-бота. Всі нові оголошення — в одному місці!',
    ...
    twitter: {
        ...
        title: 'FoxFlat — Telegram-бот для оренди квартир',
        description:
            'Отримуй нові квартири миттєво прямо в Telegram. Актуальні оголошення без спаму!',
